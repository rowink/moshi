...
const defaultSslPort = isDocker ? 443 : 4001;
const defaultPort = isDocker ? 80 : 4000;
const port = isSsl
  ? (process.env.SSL_PORT || defaultSslPort)
...
const healthCheck = client.request(requestOptions, (response) => {
